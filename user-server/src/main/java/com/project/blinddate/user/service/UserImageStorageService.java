...
import java.io.InputStream;
    ...
    private final UserImageRepository userImageRepository;
        ...
        @Transactional
    public void deleteUserImages(java.util.List<String> imageUrls) {
        if (imageUrls == null || imageUrls.isEmpty()) {
            return;
        }
        
        java.util.Set<String> targetUrls = new java.util.HashSet<>(imageUrls);
        ...
        // Delete from DB
        userImageRepository.deleteByImageUrlIn(new java.util.ArrayList<>(targetUrls));
    ...
    public String uploadProfileImage(Long userId, MultipartFile file) {
        ...
        public void saveUserImage(com.project.blinddate.user.domain.UserImage userImage) {
