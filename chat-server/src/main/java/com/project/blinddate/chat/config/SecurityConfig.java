        ...
        http
            ...
            .headers(headers -> headers
                ...
                .contentSecurityPolicy(csp -> csp.policyDirectives(
                        ...
                        "connect-src 'self' http://*.blind-date.com http://*.blind-date.site https://*.blind-date.com https://*.blind-date.site wss://*.blind-date.com wss://*.blind-date.site https://cdnjs.cloudflare.com;"
                ))
            )
